    ...
    <nav class="menu">
        <ul>
            <li class="menu-section active">
                <button><img src="/img/icon/dashboard.png"> 대시보드</button>
                <ul class="submenu">
                    <li><a href="#">- 방문자 현황</a></li>
                    <li><a href="#">- 매출 현황</a></li>
                </ul>
            </li>

            <li class="menu-section">
                <button><img src="/img/icon/admin-user.png"> 사용자 관리</button>
                <ul class="submenu">
            ...
            <li class="menu-section">
                <button><img src="/img/icon/calendar-edit.png"> 콘텐츠 관리</button>
                <ul class="submenu">
            ...
            <li class="menu-section">
                <button><img src="/img/icon/admin-card.png"> 결제 관리</button>
                <ul class="submenu">
            ...
            <li class="menu-section">
                <button><img src="/img/icon/admin-setting.png"> 시스템 관리</button>
                <ul class="submenu">
